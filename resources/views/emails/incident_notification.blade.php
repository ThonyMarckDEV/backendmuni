...
<head>
    ...
    <title>Nuevo Incidente Reportado</title>
    <style>
...
<body>
    <div class="container">
        <h1>Nuevo Incidente Reportado</h1>
        <p>Estimado/a Administrador/a,</p>
        <p>Se ha registrado un nuevo incidente en el sistema. A continuación, se detallan los datos del incidente:</p>
        ...
        <p>Por favor, revise el incidente en el sistema para tomar las acciones necesarias.</p>
